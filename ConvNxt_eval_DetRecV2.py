...
from utils.ConvNextOCR_helper_Eval import *


IMG_DIR = Path(r"D:\hvs\Hyvsion_Projects\OCR\dataset\projects\Dot_matrix_251120")
LABEL_PATH = Path(r"D:\hvs\Hyvsion_Projects\OCR\dataset\projects\Dot_matrix_251120\combined_labels_polyV2_fixed.json")

REC_CHECKPOINT = Path(r"D:\hvs\Hyvsion_Projects\OCR\trainedModel\Text_Det_Rec\run_5\Rec\best_E039_L0.244138_Rec.pth")
DET_CHECKPOINT = Path(r"D:\hvs\Hyvsion_Projects\OCR\trainedModel\Text_Det_Rec\run_5\Det\best_E326_L0.220883_Det.pth")

OUTPUT_CSV = Path(r"D:\hvs\Hyvsion_Projects\OCR\trainedModel\Text_Det_Rec\run_5\eval_rec_results.csv")

VISUALS_DIR = Path(r"D:\hvs\Hyvsion_Projects\OCR\trainedModel\Text_Det_Rec\run_5\eval_rec_visuals")
DET_BOX_VIS_DIR = Path(r"D:\hvs\Hyvsion_Projects\OCR\trainedModel\Text_Det_Rec\run_5\detected_boxes")

ROTATE_LEFT = False
ROTATE_RIGHT = False

TEXT_BOXDETECTION_INFERENCE = True   # True = Det(+GT polygons)/crop + Rec, False = Rec-only
    ...
    with torch.no_grad():
        if not TEXT_BOXDETECTION_INFERENCE:
            ...
            rec_transform = transforms.Compose([
                transforms.Resize((TEXT_IMG_H, TEXT_IMG_W), Image.BICUBIC),
                transforms.ToTensor(),
