...
from utils.ConvNextOCR_helper_train import run_recognition_epoch, run_detection_epoch, initialize_detection, \
...
Text_BoxDetection_training = False # Toggle joint text + box training vs recognition-only workflow

train_img = r"D:\hvs\Hyvsion_Projects\OCR\dataset\projects\Dot_matrix_crop_251120\test\train"
train_label = r"D:\hvs\Hyvsion_Projects\OCR\dataset\projects\Dot_matrix_crop_251120\test\train\labels.json"
val_img =  r"D:\hvs\Hyvsion_Projects\OCR\dataset\projects\Dot_matrix_crop_251120\test\train"
val_label = r"D:\hvs\Hyvsion_Projects\OCR\dataset\projects\Dot_matrix_crop_251120\test\train\labels.json"
base_dir = r"D:\hvs\Hyvsion_Projects\OCR\trainedModel\Text_Det_Rec"

backbone_fcmae = r"D:\hvs\Hyvsion_Projects\OCR\OCR_git\backbone\fcmae\convnextv2_nano_1k_224_fcmae.pt"


imgH=640 #Input image height for detection model
imgW=640 #Input image width for detection model
text_imgH=96 #Input image height for recognition model
text_imgW=96 #Input image width for recognition model
...
# MAIN
# ============================================================
def main(pre_trained_backbone=True):
    ...
    backbone_ckpt = backbone_fcmae
    use_pretrained = pre_trained_backbone
